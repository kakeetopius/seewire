...
void print_qtype(enum query_types type) {
    switch (type){
        ...
        case NS: printf("NS"); break;
        case CNAME: printf("CNAME"); break;
        case SOA: printf("SOA"); break;
        case PTR: printf("PTR"); break;
        case MX: printf("MX"); break;
        case TXT: printf("TXT"); break;
        case AAAA: printf("AAAA"); break;
        case SRV: printf("SRV"); break;
        case CAA: printf("CAA"); break;
        case ANY: printf("ANY"); break;
        case HTTPS_RR: printf("HTTPS RR"); break;
...
void print_qclass(enum query_class qclass) {
    switch(qclass) {
        ...
        case HS: printf("HS"); break;
        case ANY_CLASS: printf("ANY"); break;
